...
#include "sorting_and_searching_arrays.h"
#include "reading_input.h"


long day_1_part_1(int *input, int n) {
    int pos_smaller = 0;
    int pos_larger = n-1;
    ...
    long burger = input[pos_smaller] * input[pos_larger];
    return burger;
}


long day_1_part_2(int *input, int n) {
...
void day1(int n, string filepath) {
    ...
    long result_part1, result_part2;

    result_part1 = day_1_part_1(input, n);
    result_part1 = day_1_part_2(input, n);
}